...
#define MAX_NR_AVDTP_STREAM_ENDPOINTS        BT_CFG_MAX_NR_AVDTP_STREAM_ENDPOINTS
#define MAX_NR_AVDTP_CONNECTIONS             BT_CFG_MAX_NR_AVDTP_CONNECTIONS
...
#define MAX_NR_AVRCP_CONNECTIONS          BT_CFG_MAX_NR_AVRCP_CONNECTIONS
#define MAX_NR_AVRCP_BROWSING_CONNECTIONS BT_CFG_MAX_NR_AVRCP_BROWSING_CONNECTIONS
