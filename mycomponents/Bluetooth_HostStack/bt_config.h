...
#define BT_VENDOR_COMMON_NO_FW_SUPPORT 1 /* Support ESP32 */
...
#define BT_ENABLE_SSP 1
#else
#define BT_CLASS_OF_DEVICE 0x240414
#endif

#define PROFILE_BAS_ENABLE 0
...
#define HCI_RESET_TIMEOUT	1000 /* RT-Thread tick=1000Hz, keep reset timeout about 100ms */
